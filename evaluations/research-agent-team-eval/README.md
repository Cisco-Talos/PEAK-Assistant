...
```
output-config-a/
├── dll side-loading via trusted executables.md
├── credential dumping from LSASS.md
├── lateral movement via WMI.md
├── config-a.json          # JSONL mapping file
└── logs/
    ├── 0001_dll-side-loading.log
    ├── 0002_credential-dumping.log
    └── 0003_lateral-movement.log
```
...
**Single Mode:**
```
Evaluating: 100%|████████████████████| 13/13 [00:45<00:00, 3.5s/metric]
...
**Comparison Mode:**
```
Evaluating: 100%|████████████████████| 39/39 [02:15<00:00, 3.5s/metric]
...
Final Standings:
  1. config-a: 2 wins, 1 second place (avg: 85.3) 🏆
  2. config-b: 1 wins, 2 second place (avg: 82.1)

Metric Champions Across All Topics:
  ⭐ technical_accuracy: config-a (avg 95.0)
  ⭐ detection_quality: config-b (avg 88.5)
  ...
```
...
**Example feedback:**
- ✅ "All 10 required sections present with proper formatting"
- ⚠️ "Missing 'Published Hunts' section, otherwise complete"
- ❌ "Only 6 of 10 required sections found"
...
**Example feedback:**
- ✅ "Excellent depth with 8 code blocks, 12 specific commands, and detailed artifact analysis"
- ⚠️ "Good technical content but could use more specific examples"
- ❌ "Lacks technical depth, mostly high-level descriptions"
...
**Example feedback:**
- ✅ "All commands, paths, and technical details verified as accurate"
- ⚠️ "Minor PowerShell syntax error in one example, otherwise accurate"
- ❌ "Multiple incorrect registry paths and invalid command syntax"
...
**Example feedback:**
- ✅ "Excellent MITRE coverage: T1055.001, T1055.002 with URLs and detailed context"
- ⚠️ "Valid MITRE IDs but missing sub-technique specificity"
- ❌ "No MITRE ATT&CK references found"
...
**Example feedback:**
- ✅ "Excellent detection section with 3 Splunk queries, Sigma rule, false positive analysis, and detection gap discussion"
- ⚠️ "Good queries but lacks false positive and detection gap discussion"
- ❌ "Detection section too generic, no actionable queries"
...
**Example feedback:**
- ✅ "Comprehensive dataset documentation: Sysmon, Windows Security, EDR with field mappings and links to Microsoft documentation"
- ⚠️ "Good log sources identified but missing field-level details and documentation links"
- ❌ "Dataset section lacks specific log sources and fields"
...
**Example feedback:**
- ✅ "Names APT29, APT28 with specific campaign details and TTPs"
- ⚠️ "Mentions threat actors but lacks specific campaign details"
- ❌ "Only generic 'advanced threat actors' mentioned"
...
**Example feedback:**
- ✅ "Excellent references: 5 vendor blogs, 2 research papers, MITRE documentation"
- ⚠️ "Good references but could use more diversity"
- ❌ "Only 1 reference provided, needs more sources"
...
**Example feedback:**
- ✅ "All 8 URLs validated and accessible"
- ⚠️ "7 of 9 URLs valid, 2 returned 404"
- ❌ "5 of 8 URLs broken or inaccessible"
...
**Example feedback:**
- ✅ "Excellent log examples with field-by-field analysis and benign/malicious comparison"
- ⚠️ "Good log examples but missing field explanations"
- ❌ "No log examples provided"
...
**Example feedback:**
- ✅ "Crystal clear step-by-step instructions with rationale for each step"
- ⚠️ "Good steps but could explain 'why' more clearly"
- ❌ "Instructions too vague to follow"
...
- ⚠️ "Minor inconsistency: Detection section mentions T1055.003 but Technique Details doesn't"
- ❌ "Significant contradictions between sections"
...
**Example feedback:**
- ✅ "10 tools documented with descriptions and usage context"
- ⚠️ "Tools listed but descriptions could be more detailed"
- ❌ "Tools section empty or missing"
