...
**Example feedback:**
- ✅ "All 5 SPL queries validated: correct syntax, valid field names, proper index references"
- ⚠️ "Minor issue: 'process_name' should be 'ProcessName' in Sysmon events"
- ❌ "Multiple syntax errors: missing pipes, invalid field names, wrong index references"
...
**Example feedback:**
- ✅ "Excellent efficiency: 4 of 5 queries use tstats, early filtering, proper time scoping"
- ⚠️ "Good queries but could benefit from tstats on high-volume searches"
- ❌ "Inefficient: no tstats usage, late filtering, unbounded searches"
...
**Example feedback:**
- ✅ "Excellent progression: starts broad (all LSASS access), narrows to suspicious patterns, ends with validation"
- ⚠️ "Good steps but Step 3 should come before Step 2 for logical flow"
- ❌ "Steps are disorganized and don't build on each other"
...
**Example feedback:**
- ✅ "Perfect template conformance: all 5 required sections present with proper formatting"
- ⚠️ "All sections present but ABLE Table formatting could be improved"
- ❌ "Missing 'Recommended Time Frame' and 'ABLE Table' sections"
...
**Example feedback:**
- ✅ "Excellent alignment: all aspects of credential dumping hypothesis covered in hunt steps"
- ⚠️ "Good coverage but doesn't address the 'memory injection' aspect mentioned in hypothesis"
- ❌ "Hunt plan focuses on different technique than hypothesis describes"
...
**Example feedback:**
- ✅ "Highly actionable: step-by-step instructions, runnable queries, clear thresholds (>5 events = investigate)"
- ⚠️ "Good instructions but success criteria could be more specific"
- ❌ "Too vague: 'look for suspicious activity' without defining what that means"
...
**Example feedback:**
- ✅ "Excellent integration: excludes known admin tools via allowlist, references baseline behavior, considers backup processes, mentions local naming conventions"
- ⚠️ "Good but could include more exclusions, allowlists, or baseline references for common legitimate tools"
- ❌ "No exclusions, allowlists, or environmental context, would generate many false positives"
...
**Example feedback:**
- ✅ "Highly practical: 30-day timeframe, focused queries, reasonable data volumes"
- ⚠️ "90-day timeframe might be too long for high-volume environments"
- ❌ "Impractical: 1-year timeframe on unindexed data would take days to run"
...
**Example feedback:**
- ✅ "Comprehensive: detailed ABLE table, 5 data sources (Sysmon, Security, EDR, Network, DNS)"
- ⚠️ "Good but could include additional data sources like EDR telemetry"
- ❌ "Minimal: basic ABLE table, only 1 data source"
...
**Example feedback:**
- ✅ "Excellent threat intel: references APT29, Mimikatz usage, MITRE T1003.001, recent campaigns"
- ⚠️ "Mentions MITRE techniques but could include specific threat actor examples"
- ❌ "No threat intelligence context or actor references"
